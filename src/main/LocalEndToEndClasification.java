...
import local.voting.MajorityVoting;
...
//			AccuracyCalculating.calculateAndPrintAccuracyStatistics(FilePaths.result_file_name+"_0");
...
//			DifferenceChart.run(FilePaths.result_file_name+"_0");
		}
