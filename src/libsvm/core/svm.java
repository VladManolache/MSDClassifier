...
public class svm {
	...
	public static svm_model svm_train(svm_problem prob, svm_parameter param)
	{
		...
		else
		{
			...
			System.out.print("Calculating weighted C ... ");
			...
			System.out.print("Training k*(k-1)/2 models ... ");
			...
			System.out.print("Building output ... ");
		...
		System.out.println("Did build model! \n");
	...
	public static svm_model svm_load_model(BufferedReader fp) throws IOException
	{
		...
		System.out.print("Reading sv_coef and SV ... ");
